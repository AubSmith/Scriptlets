...
@"
 NAME: FindDuplicateNamedGPOs.ps1
 DESCRIPTION:
 Locates GPO's in a domain that have duplicate
 names
...
@"
 ...
 SYNTAX:
 FindDuplicateNamedGPOs.ps1 

 Displays an error missing query, and calls help

 FindDuplicateNamedGPOs.ps1  -query

 Lists duplicate named GPOs in the default domain

 FindDuplicateNamedGPOs.ps1 -domain nwtraders.com -query
 
 Lists duplicate named GPOs in the nwtraders.com domain

 FindDuplicateNamedGPOs.ps1 -help

 Prints the help topic for the script

 FindDuplicateNamedGPOs.ps1 -help -full

 Prints full help topic for the script

 FindDuplicateNamedGPOs.ps1 -help -examples

 Prints only the examples for the script

 FindDuplicateNamedGPOs.ps1 -examples
...
if($examples)  { funhelp }
if($full)      { funhelp }
if($query)    { funListDuplicateGPOs}
if(!$query) { funline -strIN "missing query ..." -scolor red -ucolor green -char . ; funhelp }

# SIG # Begin signature block
# MIIkCgYJKoZIhvcNAQcCoIIj+zCCI/cCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUjOcNBquKSTVvInUzLQFt0//h
# KWCggh7hMIIEEjCCAvqgAwIBAgIPAMEAizw8iBHRPvZj7N9AMA0GCSqGSIb3DQEB
...
# AgELMQ4wDAYKKwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQULmG34SfE5jAAj1Lp
# PUPetcn7Z7kwXgYKKwYBBAGCNwIBDDFQME6gJoAkAE0AaQBjAHIAbwBzAG8AZgB0
# ACAATABlAGEAcgBuAGkAbgBnoSSAImh0dHA6Ly93d3cubWljcm9zb2Z0LmNvbS9s
# ZWFybmluZyAwDQYJKoZIhvcNAQEBBQAEggEAWobAyB+NlZnpvzPSUpowSijDq89a
# 2XJePofUs8quinI7pGwdtes8XgDEr+wbtAHhZtQQqtU7RMbD4DYpETnYImzRpyvo
# pwBg2mYkVKwCRo1Q6vfoPRRG3NsbF469c4LMA6NK9QfUMxDQt2Bh2GcmTGry/qTE
# 5PhbIq7uuiFTmaqY7BoodqVXKFUaShuWVlpP7q/6nFfutjBn+wWLtAN0XbWu/jeQ
# UuUarNukG4Hn96tyJfa1fj4xOY3eoNXpLocflIMv1ADJJNlvSzn9TSD49j2nYm0n
# QHTkU3N5GEczZOd8gE5MT1ixTzy27I9n3lWinQqOm+weS2zH6xoGDcT6OqGCAh8w
...
# AQkEMRYEFK7UuFtnRZH7JQKSM/mhWB1h1ZIMMA0GCSqGSIb3DQEBBQUABIIBACmx
# kRX9DXnaYJqk9b1KPIBGO8WgyCHTjkCJURRSb0FWavXEf4qybiUu4dCH9FM3JJ6X
# iz0M31Gl5xdGNvP3n3sIvvi0+M3tiJB1/M0WvV7CiFzkMLA2NHOL7x2QfE4kI9De
# Jnfa32gy9bR+A5Mn2/ZNAUZlUOmGFrTtwXQLcUMDOFbS2DMCsvGATHcjxsdAWNOf
# gi4xRItnM3rlXUPISVyDXRumxqFIGT2WWu9yYEi0uduVL8Pl6rwPuP2JplwYhG3t
# vz7lEd/LXHz1NbI5NiW4kOBZsgU03HB9eBHt2nBQNkvQ+YE0eV2X7KeiUMw5QEJF
# T92I+KUk5VkAjtutmIA=
