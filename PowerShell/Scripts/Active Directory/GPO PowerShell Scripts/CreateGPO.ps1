...
Function funCreateGPO()
{
 ...
 if($error.count -ne 0)
   { 
    $GPMGPO.Delete()
    funline -strIN "An error occurred creating $gpoName" -scolor red
...
if($full)      { funhelp }
if($whatif)    { funWhatIf }
if($paramMissing) { "GPO name is required" ; funhelp }
if($gpoName) { funCreateGPO }

# SIG # Begin signature block
# MIIkCgYJKoZIhvcNAQcCoIIj+zCCI/cCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUCkjaamRwJhNShiZwOaESZI1j
# eTyggh7hMIIEEjCCAvqgAwIBAgIPAMEAizw8iBHRPvZj7N9AMA0GCSqGSIb3DQEB
...
# AgELMQ4wDAYKKwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQU00V8cm5fPM1AjCvz
# Mcc0/WaJH5cwXgYKKwYBBAGCNwIBDDFQME6gJoAkAE0AaQBjAHIAbwBzAG8AZgB0
# ACAATABlAGEAcgBuAGkAbgBnoSSAImh0dHA6Ly93d3cubWljcm9zb2Z0LmNvbS9s
# ZWFybmluZyAwDQYJKoZIhvcNAQEBBQAEggEAN/XUKOUOhPnQVj5Y0Kfmx7W3ZWfN
# jfBwQB2gwp6FvYbrsYm+PVueM0uVbpMarj9+wZxmd15rod/hAGqSyKP7cVBoEqop
# je9WjdIJedqFuJ9FjOAz/RAOnwglyyyIlSnm0lXqiTYauu1DXmr+6kbNOo/8hzRO
# WAOE9q5ae8HKfRf0VvNkz7jUaC5BkFbXiT3FDxl6WKyO7g6tQZFqGkt+Kj0zSxC5
# svdNkSZyee4lTOCbRMiC0R5+AmfH36ceiDqoIPS7oDYw9e+/ZVAUmj4TSkJAL3ul
# UAcNkw1GUr2TJcjsPWc1nGkgwA5Zv5axPPa3MQYFhfc6rc1dajCpd2DdaqGCAh8w
...
# hkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTA4MDEzMTIwNTY1MFowIwYJKoZIhvcN
# AQkEMRYEFDZYJQ0w0nTbuvD6m/suM+o0Na24MA0GCSqGSIb3DQEBBQUABIIBAM2G
# bweBmklK/xt/VQMVkDQamoYVR3dzc7oKrEXPgoMyt9LRiu81dcKfPVeHHWx7xGFC
# I7MiUMN3G8ldNljkqOcutRvjZZQV8Eux8qQi85LJdbuWD24LOrRRJk+GMbBGvgbJ
# 6B40314UGwfw4P3rCoRktFIcsbquTr++eqgxBH/7xvxpLh35dOambkX77SU2dBO0
# kz2HurH9Rhgy5g/bUi4v/03Bf8nHhMTB4neUP0r1W5WqdARFuCumKhU76yxdsXi2
# cwBCR0nMCWbePlueOzFnNKR9TyecUQFyrdZzhzAy2HT08sQTQpOq5oS04IGDfk/F
# gT/xegzwjx+2ZGRDj48=
