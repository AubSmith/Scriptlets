...
Function funlistNoFilter()
{
 ...
 foreach($gpo in $gpoList)
  ...
  funline("No permissions were found $($hash.count) GPOs")
...
if($examples)  { funhelp }
if($full)      { funhelp }
if($query)    { funlistNoFilter }
if(!$query) { "missing query .. " ; funhelp }

# SIG # Begin signature block
# MIIkCgYJKoZIhvcNAQcCoIIj+zCCI/cCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUP8lRYC2+W2dvQ/2G4VFiap1G
# lI6ggh7hMIIEEjCCAvqgAwIBAgIPAMEAizw8iBHRPvZj7N9AMA0GCSqGSIb3DQEB
...
# AgELMQ4wDAYKKwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQUp3Oo+PzNd7EhYn8m
# iqdUbw2rsQMwXgYKKwYBBAGCNwIBDDFQME6gJoAkAE0AaQBjAHIAbwBzAG8AZgB0
# ACAATABlAGEAcgBuAGkAbgBnoSSAImh0dHA6Ly93d3cubWljcm9zb2Z0LmNvbS9s
# ZWFybmluZyAwDQYJKoZIhvcNAQEBBQAEggEAVmxKQ3qJRZ4FG8F4aucXHTmL7ljM
# zklXGPi/F7upLfeMxf9egd9OmuRDDV7G40USiWPVlk3c5WbzT3X2fKGieZRV2fv1
# k+VUNbgwPP0i1S09ub1PWraK5glYea1v8RFjqObjvE7YXpbMUsKYtFvW/sbfm27a
# KFKvfNjFl0cD1d0C8eAZmK2ofURZ5AeHl5yvk5yE/UXkRYTgQeqjZvYPXhJA1QN/
# I1oewDYOT3CCHlq3ypXsvGDSsqLVLv77MNkUrEYxDClXRAOHzgM0sNUR9kNbowMG
# uMJopFQwfG2KS5AcFDL0KCwtte3nURdTGmhkM1CJ/Gf+9KZfKYMTPfUtM6GCAh8w
...
# AQkEMRYEFPFTn6OXJFaVN/zQEaqtObvA1YWOMA0GCSqGSIb3DQEBBQUABIIBAB86
# pwBOHeoqztjDT3fVagO6o1eYXhX7wcHZDV8rmXh+TXlebFIT4AH7elQDGDepBDNY
# cZbsxMyb0QxuKyJ3OEe1rgeihAHHqfB7v4qullyU4o0dcu4UI5y7qOSflZCq8HY/
# lgdEqQfl94K1B+NjAGx/r1zkTFq1R2fTy5zSO26OOhpD992jAUR9j2S72RtCVXc+
# tUuIvWO1NdO2ICSOqTbtxUc7ZxAeiGTfVbsuyZ4esc8STSFEwLKoveqZ81m2LLzM
# 8YcDaLfQhf8UhUQLAi3HPSO1QmBg9yrTIv5u5Up0RXcrQ98SmOt/zKGeYj3zmKCx
# Ce5iGNXXXnrsNRiFqYE=
